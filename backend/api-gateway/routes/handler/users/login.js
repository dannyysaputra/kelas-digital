...
module.exports = async (req, res) => { 
    try {
        const user = await axios.post(`${URL_SERVICE_USER}/users/login`, req.body);
        ...
        await axios.post(`${URL_SERVICE_USER}/refresh_tokens`, { refresh_token: refreshToken, user_id: data.id });
